...
public class CustomScreen extends Screen {
    ...
    protected void init() {
        ...
        ButtonWidget buttonWidget2 = ButtonWidget.builder(Text.of("Back"), (btn) -> {
                    MinecraftClient.getInstance().setScreen(null);
                }).dimensions(40, 80, 120, 20).build();
        // x, y, width, height
        // It's recommended to use the fixed height of 20 to prevent rendering issues with the button
        // textures.
        DraggableWidget customWidget = new DraggableWidget(HudManager.temporaryX, HudManager.temporaryY, 120, 20);
